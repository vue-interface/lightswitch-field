...
var render = function() {
  ...
  return _c("div", { class: _vm.formGroupClasses }, [_c("div", { ref: "input", class: _vm.controlClasses, attrs: { "tabindex": "0" }, on: { "click": function($event) {
    ...
    var _obj;
    return [_vm.label ? _c("label", { class: (_obj = {}, _obj[_vm.labelClass] = !!_vm.labelClass, _obj), staticStyle: { "padding-left": ".5em" }, attrs: { "for": _vm.$attrs.id } }, [_vm._t("default", function() {
